...
export PATH="/usr/local/opt/curl/bin:$HOME/.yarn/bin:/usr/local/bin:/usr/local/sbin:$HOME/bin:$PNPM_HOME:$HOME/.local/bin:$PATH"
...
# Make sure npm global binaries stay ahead of fnm-managed shims
